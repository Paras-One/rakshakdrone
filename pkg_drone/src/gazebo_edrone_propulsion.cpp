#include <algorithm>
#include <assert.h>
#include "pkg_drone/gazebo_edrone_propulsion.h"
...
namespace gazebo
{
  ...
  //*****************************************************************************************************************************************************************************  
    ...
    ros::SubscribeOptions so = ros::SubscribeOptions::create<pkg_drone::prop_speed>(
      this->topic_name_,1,
    ...
    ROS_INFO("Vitarana Drone version 0.2.1");
  ...
  void ModelJointControler::OnRosMsg_prop_speed(const pkg_drone::prop_speedConstPtr &_msg)
  {
